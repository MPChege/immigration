...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Relocations
        origins = ['New York, NY', 'Los Angeles, CA', 'Chicago, IL', 'Houston, TX', 'Phoenix, AZ', 'Miami, FL']
        destinations = ['Miami, FL', 'Seattle, WA', 'Boston, MA', 'Denver, CO', 'Atlanta, GA', 'Portland, OR', 'San Francisco, CA']
